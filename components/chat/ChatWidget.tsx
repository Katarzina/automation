...
export default function ChatWidget() {
  ...
  return (
    <>
      {/* Chat window */}
      {open && (
        <div className="fixed bottom-24 right-4 sm:right-6 z-50 w-[calc(100vw-2rem)] sm:w-96 flex flex-col bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden" style={{ maxHeight: '520px' }}>
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 bg-blue-800 text-white">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-blue-200 mt-0.5">Automation Studio</p>
              </div>
            </div>
          ...
          {/* Messages */}
          <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-gray-50" style={{ minHeight: '300px', maxHeight: '380px' }}>
            {messages.map((msg, i) => (
          ...
          <div className="px-3 py-3 bg-white border-t border-gray-100">
            {leadCaptured ? (
              <p className="text-center text-sm text-gray-400 py-1">Conversation complete — check your email!</p>
            ) : (
