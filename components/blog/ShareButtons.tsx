...
export default function ShareButtons({ title, shareLabel, copyLabel, copiedLabel }: Props) {
  ...
  return (
    <div className="mt-12 pt-8 border-t border-stone-200">
      <p className="text-xs text-stone-400 uppercase tracking-widest mb-4">{shareLabel}</p>
      <div className="flex flex-wrap gap-3">
        <a
          href={`https://www.linkedin.com/sharing/share-offsite/?url=${encoded}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white border border-stone-200 text-stone-600 hover:border-indigo-300 hover:text-indigo-600 transition-colors text-sm"
        >
